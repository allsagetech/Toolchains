...
function Test-ProductionReadinessPolicies {
	...
	Assert-True ($workflowText -match '-RedirectStandardOutput \$stdoutPath' -and $workflowText -match '-RedirectStandardError \$stderrPath') 'Cosign verification does not use file-backed child-process output.'
