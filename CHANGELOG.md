...
- Disable large-model publication jobs and replace hanging live transparency-log lookups with offline verification of Cosign's signed Rekor bundles, file-backed subprocess output, and bounded internal, process, and GitHub step deadlines.
